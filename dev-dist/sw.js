...
define(['./workbox-8d0d8005'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^\/api\/(products|categories|customers)/, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\.(png|svg|ico|jpg|webp)$/, new workbox.CacheFirst({
    "cacheName": "images-v1",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 50,
